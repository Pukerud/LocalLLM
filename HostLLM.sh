...
while true; do
    ...
    echo "  Quick Start:"
    echo "  ────────────"
    echo -e "  ${BOLD}[1]${RESET} Swift 1.5 Uncensored Q8  ⚡ BF16 vision │ 2 native-262K slots │ native MTP + Q8 K/V │ xhigh reasoning"
    echo -e "      Uses all four RTX 3090 GPUs; profile menu selects installed alternatives"
    echo -e "  ${BOLD}[Q]${RESET} Qwen3.8 profile menu (alias for [1])"
    echo -e "      Only installed models are listed; missing/download-only profiles remain CLI-accessible"
    echo ""
