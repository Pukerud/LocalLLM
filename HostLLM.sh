...
while true; do
    ...
    echo "  Quick Start:"
    echo "  ------------"
    echo -e "  ${BOLD}[0]${RESET} Quick Start           BeeLlama DFlash — up to 105 tok/s, vision, reasoning, dual GPU (no draft) (Tested on 3090)"
    echo -e "  ${BOLD}[1]${RESET} Quick Start (Legacy)  MTP — up to 100 tok/s, no vision, dual GPU (Tested on 4090)"
    echo ""
    echo "  Engines:"
    echo "  -------"
