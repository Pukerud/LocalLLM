...
Menu9/10 and CLI profiles swift15-q8/swift15-q4 are added as experimental, using pinned checksummed assets, full262K/one slot, F16vision, Q8KV and xhigh; MTP stays off. Tests cover menu routing/default preservation, arguments, download manifest and incompatible MTP override rejection. Download and actual Swift inference remain user-invoked; no claim of measured new-model speedup or full-context validation.
